...
namespace ImGuiNET
{
	...
	public unsafe delegate void Platform_GetWindowPos(Vector2 pos, ImGuiViewportPtr viewport);
	public delegate void Platform_SetWindowSize(ImGuiViewportPtr vp, Vector2 size);
	public unsafe delegate void Platform_GetWindowSize(Vector2 size, ImGuiViewportPtr viewport);
	...
	public delegate void Platform_SetWindowTitle(ImGuiViewportPtr vp, string title);
}